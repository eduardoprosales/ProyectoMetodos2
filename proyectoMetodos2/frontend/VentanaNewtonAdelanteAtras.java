...
import proyectoMetodos2.backend.NewtonAdelanteAtras;

public class VentanaNewtonAdelanteAtras extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private JTextField tfx1;
	private NewtonAdelanteAtras naa;//declara objeto de newton a-a
	...
	public static void main(String[] args) {
		try {
			VentanaNewtonAdelanteAtras dialog = new VentanaNewtonAdelanteAtras();
	 ...
	 * Create the dialog.
	 */
	public VentanaNewtonAdelanteAtras() {
		...
		{
			JLabel lblNewLabel = new JLabel("Newton Hacia Adelante y Atrás");//nombre de la ventana
			lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
			lblNewLabel.setBounds(10, 11, 462, 17);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						naa = new NewtonAdelanteAtras(x,y);
						//
						textArea.setText(naa.getResultado());
					}
				});
